...
class PodcastsControllerTest < ActionController::TestCase
  ...
  test "should create podcast" do
    assert_difference('Podcast.count') do
      post :create, podcast: { description: @podcast.description, image: @podcast.image, name: @podcast.name, url_itunes: @podcast.url_itunes, url_rss: @podcast.url_rss, url_web: @podcast.url_web }
    end
  ...
  test "should update podcast" do
    patch :update, id: @podcast, podcast: { description: @podcast.description, image: @podcast.image, name: @podcast.name, url_itunes: @podcast.url_itunes, url_rss: @podcast.url_rss, url_web: @podcast.url_web }
    assert_redirected_to podcast_path(assigns(:podcast))
  end
