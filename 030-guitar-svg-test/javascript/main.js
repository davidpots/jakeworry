var dot = '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="52px" height="80px" viewBox="0 0 52 80" enable-background="new 0 0 52 80" xml:space="preserve">\
              <circle class="svg-dot" fill="#27AAE1" cx="26" cy="40" r="24"/>\
            </svg>';
var fretboard = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="416px"\
...
$(document).ready(function(){
  ...
  $.each( toReplace, function(i,el) {
    ...
    if (el == "o") {
      ...
      replacement += "<div class='dot dot-empty'>"+dot+"</div>";
    } 
  });
